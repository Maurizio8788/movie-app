<template>
  <MainComponent hasContainer centererd>
    ...
    <SectionHeading
      title="Cosa é popolare"
      @change-tabs-evt="tabsChangeHandler"
      :tabs="popularTabsTitles"
    >
        ...
        <Tabs @tabs-title-evt="getPopularTabsTitle">
          <Tab title="Films" type="movie">
            <CarouselCard
              mediaType="movie"
              :spaceBetween="20"
              :slides="movieStore.popularMovie"
            ></CarouselCard>
          </Tab>
      ...
      <template #header>
        <div class="px-4 flex justify-between items-center w-full">
          <h3 class="text-ellipsis">
            {{ movieStore.movieTrailer.name || tvsShows.tvSeriesTrailer.name }}
          </h3>
          <button
        ...
        <div class="w-full h-[632px] block overflow-hidden">
          <iframe
            ...
            :src="`https://www.youtube.com/embed/${
              movieStore.movieTrailer.key || tvsShows.tvSeriesTrailer.key
